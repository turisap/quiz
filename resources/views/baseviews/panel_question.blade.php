    ...
    <div class="row radio-row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                <input class="form-control" id="answer1-2" type="text" name="answer1-2" placeholder="Second answer">
            </div>
        </div>
        <div class="col-sm-1">
            <div class="form-group">
    ...
    <div class="row radio-row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                <input class="form-control" type="text" id="answer1-4" name="answer1-4" placeholder="Fourth answer">
            </div>
        </div>
        <div class="col-sm-1">
            <div class="form-group">
