...
<script>
    $(document).ready(function() {
        setInterval(makeMeAcidic, 50);
    });

    function makeMeAcidic () {
        ...
        first.animate({'top' : '-10px', 'left' : '-5px'}, 500).delay(300).animate({'top' : '0px', 'left' : '0px'}, 1500).delay(100)
            ...
            .animate({'top' : '0px', 'left' : '-13px'}, 50).delay(700).animate({'top' : '0px', 'left' : '0px'}, 500).delay(300);
        ...
        second.animate({'top' : '-5px', 'left' : '+6px'}, 300).delay(600).animate({'top' : '0px', 'left' : '0px'}, 900).delay(300)
            ...
            .animate({'top' : '5px', 'left' : '-4px'}, 600).delay(400).animate({'top' : '0px', 'left' : '0px'}, 500).delay(100);
        ...
        third.animate({'top' : '8px', 'left' : '+6px'}, 600).delay(200).animate({'top' : '0px', 'left' : '0px'}, 100).delay(500)
            ...
            .animate({'top' : '-8px', 'left' : '-0px'}, 400).delay(1100).animate({'top' : '0px', 'left' : '0px'}, 400).delay(100)
            .animate({'top' : '0px', 'left' : '-13px'}, 50).delay(700).animate({'top' : '0px', 'left' : '0px'}, 500).delay(300);
        ...
        fourth.animate({'top' : '5px', 'left' : '-6px'}, 400).delay(200).animate({'top' : '0px', 'left' : '0px'}, 400).delay(800)
            ...
            .animate({'top' : '0px', 'left' : '5px'}, 500).delay(500).animate({'top' : '0px', 'left' : '0px'}, 500).delay(100);
        ...
        sixth.animate({'top' : '0px', 'left' : '-2px'}, 400).delay(200).animate({'top' : '0px', 'left' : '0px'}, 400).delay(300)
            ...
            .animate({'top' : '-2px', 'left' : '-8px'}, 800).delay(200).animate({'top' : '0px', 'left' : '0px'}, 500).delay(100);
    }
</script>
